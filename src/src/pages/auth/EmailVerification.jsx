  ...
  return (
    <div className="animate-fade-in">
      <PageHeader 
        ...
        breadcrumb={[{ label: 'Dashboard', href: '/dashboard' }, { label: 'EmailVerification' }]}
      />
      <Card className="flex flex-col items-center justify-center min-h-[50vh] text-center p-8">
        <div className="w-16 h-16 rounded-2xl bg-indigo-50 flex items-center justify-center mb-4">
          <Mail size={32} className="text-indigo-600 animate-pulse-glow" />
        </div>
        <h2 className="text-2xl font-bold text-slate-800 mb-2">Email Verification</h2>
        <p className="text-slate-500 max-w-md">Verify your email to secure your account.</p>
      </Card>
    </div>
  );
}
